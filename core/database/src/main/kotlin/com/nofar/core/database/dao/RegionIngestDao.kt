...
/**
 * Driver-safe transactional ingest. [androidx.room.withTransaction] requires
 * SupportSQLiteOpenHelper and crashes with [BundledSQLiteDriver].
 */
@Dao
abstract class RegionIngestDao {
    ...
    protected abstract suspend fun insertCoverage(coverage: RegionEntityCoverageEntity): Long

    @Transaction
    open suspend fun upsertAndLinkEntity(regionId: String, entity: GeoEntityEntity, displayName: String) {
